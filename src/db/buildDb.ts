 ...
 * bookkeeping, the per-doc CRDT update log, and the collaboration-room membership
 * (`shares`, whose key material is device-bound). Everything else is content that
