...
export const resources = {
  ...
  it: partial({ common: itCommon, chrome: itChrome, app: itApp, templates: itTemplates, tours: itTours, help: itHelp }),
  pl: partial({ common: plCommon, chrome: plChrome, app: plApp, templates: plTemplates, tours: plTours, help: plHelp }),
  sv: partial({ common: svCommon, chrome: svChrome, app: svApp, templates: svTemplates, tours: svTours, help: svHelp }),
  da: partial({ common: daCommon, chrome: daChrome, app: daApp, templates: daTemplates, tours: daTours, help: daHelp }),
  nb: partial({ common: nbCommon, chrome: nbChrome, app: nbApp, templates: nbTemplates, tours: nbTours, help: nbHelp }),
  is: partial({ common: isCommon, chrome: isChrome, app: isApp, templates: isTemplates, tours: isTours, help: isHelp }),
  ga: partial({ common: gaCommon, chrome: gaChrome, app: gaApp, templates: gaTemplates, tours: gaTours, help: gaHelp }),
  lt: partial({ common: ltCommon, chrome: ltChrome, app: ltApp, templates: ltTemplates, tours: ltTours, help: ltHelp }),
  lv: partial({ common: lvCommon, chrome: lvChrome, app: lvApp, templates: lvTemplates, tours: lvTours, help: lvHelp }),
  et: partial({ common: etCommon, chrome: etChrome, app: etApp, templates: etTemplates, tours: etTours, help: etHelp }),
  cs: partial({ common: csCommon, chrome: csChrome, app: csApp, templates: csTemplates, tours: csTours, help: csHelp }),
  hu: partial({ common: huCommon, chrome: huChrome, app: huApp, templates: huTemplates, tours: huTours, help: huHelp }),
  ro: partial({ common: roCommon, chrome: roChrome, app: roApp, templates: roTemplates, tours: roTours, help: roHelp }),
  bg: partial({ common: bgCommon, chrome: bgChrome, app: bgApp, templates: bgTemplates, tours: bgTours, help: bgHelp }),
  el: partial({ common: elCommon, chrome: elChrome, app: elApp, templates: elTemplates, tours: elTours, help: elHelp }),
  ja: partial({ common: jaCommon, chrome: jaChrome, app: jaApp, templates: jaTemplates, tours: jaTours, help: jaHelp }),
  'zh-Hans': partial({ common: zhHansCommon, chrome: zhHansChrome, app: zhHansApp, templates: zhHansTemplates, tours: zhHansTours, help: zhHansHelp }),
  ko: partial({ common: koCommon, chrome: koChrome, app: koApp, templates: koTemplates, tours: koTours, help: koHelp }),
  hi: partial({ common: hiCommon, chrome: hiChrome, app: hiApp, templates: hiTemplates, tours: hiTours, help: hiHelp }),
  ta: partial({ common: taCommon, chrome: taChrome, app: taApp, templates: taTemplates, tours: taTours, help: taHelp }),
  si: partial({ common: siCommon, chrome: siChrome, app: siApp, templates: siTemplates, tours: siTours, help: siHelp }),
  am: partial({ common: amCommon, chrome: amChrome, app: amApp, templates: amTemplates, tours: amTours, help: amHelp }),
  sw: partial({ common: swCommon, chrome: swChrome, app: swApp, templates: swTemplates, tours: swTours, help: swHelp }),
  ha: partial({ common: haCommon, chrome: haChrome, app: haApp, templates: haTemplates, tours: haTours, help: haHelp }),
  yo: partial({ common: yoCommon, chrome: yoChrome, app: yoApp, templates: yoTemplates, tours: yoTours, help: yoHelp }),
  zu: partial({ common: zuCommon, chrome: zuChrome, app: zuApp, templates: zuTemplates, tours: zuTours, help: zuHelp }),
  mi: partial({ common: miCommon, chrome: miChrome, app: miApp, templates: miTemplates, tours: miTours, help: miHelp }),
  sm: partial({ common: smCommon, chrome: smChrome, app: smApp, templates: smTemplates, tours: smTours, help: smHelp }),
  to: partial({ common: toCommon, chrome: toChrome, app: toApp, templates: toTemplates, tours: toTours, help: toHelp }),
};
