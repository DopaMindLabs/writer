...
- **Display name** — the name that will sit beside your cursor when you
...
Type the name you'd like collaborators to see. It's optional — leave it empty and
you're shown as *Anonymous*. The name is saved as you edit, and will label your
cursor when you write alongside other people.

## Presence colour

Pick the colour that will mark your cursor and selection to others, from five muted
hues: **terracotta**, **slate blue**, **moss**, **plum**, or **ochre**. The chosen
swatch is ringed.

The swatches form a single control. Click one to choose it, or move between them
from the keyboard: **Left**/**Up** and **Right**/**Down** step through the hues
(wrapping around at the ends), and **Home**/**End** jump to the first or last.
