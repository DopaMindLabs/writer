...
describe('HomeCloudSignInButton', () => {
  ...
  it('invites sign-in, linking to the cloud sync tab, when the beta is on and signed out', () => {
    ...
    expect(link).toHaveAttribute('href', expect.stringContaining('tab=cloudSync'));
