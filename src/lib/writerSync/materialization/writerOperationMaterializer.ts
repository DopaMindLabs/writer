...
import { openOperationPayload } from '@/lib/writerSync/crypto/operationCrypto';
import { compareOperations, supersedes } from '@/lib/writerSync/operations/convergence';
import { verifyFrame } from '@/lib/writerSync/operations/operationCodec';
import type { MaterializeResult } from '@/lib/writerSync/operations/materializer.types';
import type {
  EncryptedSyncFrame,
  SyncTombstone,
