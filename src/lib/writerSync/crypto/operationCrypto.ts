import { tagBinary, untagBinary, toBase64, fromBase64 } from '@/lib/cloud/crypto/binaryJsonCodec';
import type { SyncOperationHeader } from '@/lib/writerSync/operations/operation.types';
