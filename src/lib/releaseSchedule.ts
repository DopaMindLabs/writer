...
/**
 * When the next release ships: 23 August 2026, 22:00 CEST (20:00 UTC). The
 * pre-release banner counts down to this moment and disappears once it passes.
 */
export const NEXT_RELEASE_AT = Date.UTC(2026, 7, 23, 20, 0, 0);

/** Human-readable release moment for copy interpolation. */
export const NEXT_RELEASE_LABEL = '23 August, 22:00 CEST';
